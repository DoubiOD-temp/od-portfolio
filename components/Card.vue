...
const tagColors: { [key: string]: { bg: string; text: string } } = {
  ...
  "Bun": { bg: '#000000', text: '#ffffff' },
  "Cloudflare R2": { bg: '#F38020', text: '#000000' },
  "Framer Motion": { bg: '#FFE023', text: '#000000' },
  "Hono": { bg: '#E36002', text: '#000000' },
  "Next.js": { bg: '#000000', text: '#ffffff' },
  "Node.js": { bg: '#5FA04E', text: '#000000' },
  "Pixi.js": { bg: '#E72264', text: '#000000' },
  "Playwright": { bg: '#2EAD33', text: '#000000' },
  "PostgreSQL": { bg: '#4169E1', text: '#ffffff' },
  "React": { bg: '#61DAFB', text: '#000000' },
  "React.js": { bg: '#61DAFB', text: '#000000' },
  "Server-Sent Events": { bg: '#E34F26', text: '#000000' },
  "Shopify Storefront API": { bg: '#7AB55C', text: '#000000' },
  "Supabase": { bg: '#3FCF8E', text: '#000000' },
  "TypeScript": { bg: '#3178C6', text: '#ffffff'},
  "Vercel": { bg: '#000000', text: '#ffffff' },
  "Vercel AI SDK": { bg: '#000000', text: '#ffffff' },
  "Vite": { bg: '#9135FF', text: '#ffffff' },
  "Vue.js": { bg: '#4FC08D', text: '#ffffff'},
  "WebGL": { bg: '#990000', text: '#ffffff' },
