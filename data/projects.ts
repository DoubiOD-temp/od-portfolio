...
export const projects: Project[] = [
  {
    title: "LectureGuru",
    tags: ["Next.js", "TypeScript", "Vercel AI SDK", "Drizzle ORM", "Supabase", "PostgreSQL", "Cloudflare R2", "Trigger.dev", "Remotion", "Playwright", "Tailwind CSS"],
    ...
    description: "During a 16-week internship at Aigency, I worked on LectureGuru: an AI platform for creating training presentations, browser-based slide decks, narrated videos, quizzes, and exportable learning materials. When I started, conversations, source files, and generated outputs lived mostly as separate objects and presentations were centred on static files. By the end, projects grouped chats, sources, branding, instructions, and generated decks into one workspace, and interactive slides supported quizzes, charts, voiceovers, sharing, analytics, and exports, making the platform a more complete tool for creating, editing, exporting, localizing, and sharing interactive learning content.",
    collaborators: "2",
    highlights: [
      ...
      "Extended the interactive slide system with browser-native decks, charts, images, ElevenLabs voiceovers, and quiz slides",
      "Worked on editor tooling for text, charts, images, audio, layout, themes, and assistant-driven changes grounded in the current deck state",
      "Added sharing and analytics: public and private links, invitations, viewer activity, quiz results, and CSV exports",
      "Built a Custom AI presentation path where a sandboxed background coding agent generates, validates, builds, and publishes bespoke decks, with hybrid editing and safe rebuilds",
      "Cut video export time for a 20-slide deck from over 3 minutes to under 1 minute by parallelising slide capture and audio download",
      "Improved PDF and video exports, background jobs, signed storage links, credit handling, validation, authorization, cache invalidation for share links, and Slovak-English localization"
    ],
    year: 2026,
  ...
  {
    title: "Training Session Management platform",
