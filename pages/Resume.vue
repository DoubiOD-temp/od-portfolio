...
const downloadCV = () => {
  window.open('/CV/Dobis_CV_0926.pdf', '_blank');
};
...
const workEvents = [
  {
    ...
    side: 'left',
    bullets: [
      'Engineered an AI platform turning source material into multi-format training content, from presentations and narrated videos to PDFs and web courses built for team use.',
      'Developed custom e-commerce platforms end-to-end, translating designs into pixel-exact implementations.',
      'Worked across an AI legal platform that grounds its answers in statutory and case law rather than model memory.'
    ]
  },
  {
    title: 'IT Tester ext.',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Created automatic telemetry download script using Python',
  ...
  },
  {
    ...
    side: 'right',
    bullets: [
      'Built an internal ticket management system, enhancing operational efficiency within the organization'
    ]
  },
  {
    ...
    bullets: [
      ...
      'Created visualizations of aircraft & vessel performance based on historical data analysis',
  ...
  },
  {
    ...
    side: 'right',
    bullets: [
      'Wrote software requirements, documentation, and ran user acceptance testing',
...
const academicEvents = [
  {
    ...
    side: 'left',
    bullets: [
      'Specialisation on machine learning and deep learning',
      'Java and .NET development, web development using PHP Laravel, data science with Python, business process management and ITIL'
    ]
  },
  {
    title: 'University of Padua',
    subtitle: 'Computer Engineering (Erasmus exchange)',
    ...
    bullets: [
      ...
      'Data structures and algorithms, quality engineering, and project management'
    ]
  },
  {
    title: 'University College of Northern Denmark',
    ...
    side: 'left',
    bullets: [
      'Advanced programming techniques and OOP with Java & .NET',
      'Software design, business analysis, SQL, quality assurance (QA), integration testing, distributed systems and Agile methodologies',
      'Final grade - 10'
    ]
  },
  {
    title: '1. súkromné gymnázium v Bratislave',
    subtitle: 'Gymnázium (grammar school)',
    location: 'Bratislava, Slovakia',
    dateRange: '2013 – 2021',
    dotColor: '#51A67F', // 1SG green
    side: 'right',
    bullets: [
      'Specialized coursework in advanced mathematics and programming',
